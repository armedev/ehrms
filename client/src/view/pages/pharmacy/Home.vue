          ...
          <div class="card-body">
            ...
            >
              <div class="d-flex flex-column mr-5">
                ...
                <p class="text-dark-50">Click here to view all generic drugs</p>
              </div>
          ...
          <div class="card-body">
            ...
            >
              <div class="d-flex flex-column mr-5">
                ...
                <p class="text-dark-50">Click here to view all dosage forms</p>
              </div>
              <div class="ml-6 ml-lg-0 ml-xxl-6 flex-shrink-0">
                <router-link
                  to="/pharmacy/dosage-forms"
          ...
          <div class="card-body">
            ...
            >
              <div class="d-flex flex-column mr-5">
                ...
                <p class="text-dark-50">Click here to view all drugs strength or volumes</p>
              </div>
              <div class="ml-6 ml-lg-0 ml-xxl-6 flex-shrink-0">
                <router-link
                  to="/pharmacy/dosage-measurements"
