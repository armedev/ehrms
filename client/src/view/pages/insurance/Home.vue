          ...
          <div class="card-body">
            ...
            >
              <div class="d-flex flex-column mr-5">
                ...
                <p class="text-dark-50">Click here to view health insurance types</p>
              </div>
      ...
      <div class="col-lg-6 col-xl-4 mb-10">
        ...
        <div class="card card-custom mb-2 bg-diagonal">
          <div class="card-body">
            ...
            >
              <div class="d-flex flex-column mr-5">
                <router-link to="/insurance/hmo" class="h4 text-dark text-hover-primary mb-5">
                  HMOs
                </router-link>
                <p class="text-dark-50">Click here to view all health isnurance HMOs</p>
              </div>
              <div class="ml-6 ml-lg-0 ml-xxl-6 flex-shrink-0">
                <router-link
                  to="/insurance/hmo"
          ...
          <div class="card-body">
            ...
            >
              <div class="d-flex flex-column mr-5">
                ...
                <p class="text-dark-50">Click here to view the various health insurance policies</p>
              </div>
              <div class="ml-6 ml-lg-0 ml-xxl-6 flex-shrink-0">
                <router-link
                  to="/insurance/hmo"
